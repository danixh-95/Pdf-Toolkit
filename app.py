...
.file-name { font-weight: 500; color: #FFFFFF; flex-grow: 1; }
.file-size { color: rgba(255,255,255,0.4); font-size: 0.8rem; }
...
st.markdown("""
<div class="hero">
  <div class="hero-eyebrow-badge">✦ Document Intelligence Suite</div>
  <h1 class="hero-title">Transform Documents Effortlessly</h1>
  <p class="hero-sub">Merge · Split · Extract · Watermark — beautifully engineered for modern workflows.</p>
</div>
""", unsafe_allow_html=True)
...
<div style="padding:1.25rem; background:rgba(6,182,212,0.03); border:1px solid rgba(6,182,212,0.15);
            border-radius:16px; font-size:0.8rem; color:rgba(255,255,255,0.55); line-height:1.75;">
  <b style="color:#06B6D4; font-family:'Syne',sans-serif;">ℹ️ SECURITY</b><br>
  All processing is executed in-memory. No files are ever stored on the server.
</div>
""", unsafe_allow_html=True)
